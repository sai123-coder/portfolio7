...
export default function Contact() {
  ...
  const handleSubmit = async (e) => {
    ...
    form.append("access_key", "e2dc4b76-a4cb-4291-9ea7-4e23a793c7e9");
                ...
                {[
                  {
                    ...
                    title: "Email",
                    content: "upputholakeerthisai@gmail.com",
                  },
                  {
                    icon: <Phone className="w-6 h-6 text-green-400" />,
                    title: "Phone",
                    content: "+91-9391873119",
                  },
                  {
                    icon: <Linkedin className="w-6 h-6 text-blue-400" />,
                    title: "LinkedIn",
                    content:
                      "https://www.linkedin.com/in/upputholla-keerthi-sai-kumar-431283280/",
                    link: true,
                  },
                  {
                    icon: <Github className="w-6 h-6 text-gray-400" />,
                    title: "LeetCode",
                    content: "https://leetcode.com/u/Keerthi_sai001/",
                    link: true,
                  },
                  {
                    icon: <Github className="w-6 h-6 text-gray-400" />,
                    title: "GitHub",
                    content: "https://github.com/sai123-coder",
                    link: true,
                  },
                  {
                    ...
                    title: "GeeksforGeeks",
                    content:
                      "https://www.geeksforgeeks.org/profile/upputholaky4cz",
                    link: true,
                  },
                  {
